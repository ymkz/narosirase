...
const AdditionHeaderComponent = ({ navigation, valid, handleSubmit }) => (
  <View style={styles.container}>
    <TouchableOpacity style={styles.actions} onPress={() => navigation.goBack()}>
      <Entypo name="chevron-thin-left" size={20} color={materialColors.blackPrimary} />
      <Text style={[human.callout, styles.text]}>Back</Text>
    </TouchableOpacity>
    <View style={styles.contents}>
      <Text style={[human.largeTitle, systemWeights.bold, styles.primary]}>Addition</Text>
      <Entypo
        name="paper-plane"
        size={32}
